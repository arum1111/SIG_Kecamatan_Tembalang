...
var style_PerbandinganPenduduk_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("JMLHPDDK");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 5000.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 15000.000000 && value <= 20000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 20000.000000 && value <= 42000.000000) {
            style = [ new ol.style.Style({
